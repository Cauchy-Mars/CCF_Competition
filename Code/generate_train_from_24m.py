...
def generate_train_salesVolume(data):
    #读入数据
...
def generate_train_popularity(data):
    #读入数据
    base_columns = ['province', 'adcode', 'model', 'bodyType']
    fix1 = 'salesVolume'
    fix2 = 'popularity'
    ...
    for i in range(1, 13):
        ...
        change_columns.append(fix2 + str(i))
    final_columns = base_columns+change_columns+['pred']
    data_1 = concat_x_y(data, base_columns+change_columns, [fix2+str(13)], final_columns)
    change_columns = []
    for i in range(2, 14):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_2 = concat_x_y(data, base_columns+change_columns, [fix2+str(14)], final_columns)
    change_columns = []
    for i in range(3, 15):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_3 = concat_x_y(data, base_columns+change_columns, [fix2+str(15)], final_columns)
    change_columns = []
    for i in range(4, 16):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_4 = concat_x_y(data, base_columns+change_columns, [fix2+str(16)], final_columns)
    change_columns = []
    for i in range(5, 17):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_5 = concat_x_y(data, base_columns+change_columns, [fix2+str(17)], final_columns)
    change_columns = []
    for i in range(6, 18):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_6 = concat_x_y(data, base_columns+change_columns, [fix2+str(18)], final_columns)
    change_columns = []
    for i in range(7, 19):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_7 = concat_x_y(data, base_columns+change_columns, [fix2+str(19)], final_columns)
    change_columns = []
    for i in range(8, 20):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_8 = concat_x_y(data, base_columns+change_columns, [fix2+str(20)], final_columns)
    change_columns = []
    for i in range(9, 21):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_9 = concat_x_y(data, base_columns+change_columns, [fix2+str(21)], final_columns)
    change_columns = []
    for i in range(10, 22):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_10 = concat_x_y(data, base_columns+change_columns, [fix2+str(22)], final_columns)
    change_columns = []
    for i in range(11, 23):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_11 = concat_x_y(data, base_columns+change_columns, [fix2+str(23)], final_columns)
    change_columns = []
    for i in range(12, 24):
        change_columns.append(fix1 + str(i))
        change_columns.append(fix2 + str(i))
    data_12 = concat_x_y(data, base_columns+change_columns, [fix2+str(24)], final_columns)
